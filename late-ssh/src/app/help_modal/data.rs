...
fn settings_help_lines() -> Vec<String> {
    ...
    vec![
        ...
        "tmux strips notification escapes by default; see the Notifications tab for passthrough setup."
            .to_string(),
        "Notifications can fire for DMs, mentions, friend joins and go-lives, game events, and stream viewers.".to_string(),
...
fn streaming_help_lines() -> Vec<String> {
    [
        ...
        "  into your stream room, you get an `is watching` banner plus a desktop",
        "  notification (settings row: Stream viewers), and #lounge gets an",
        "  `is watching` line.",
