...
fn overview_lines() -> Vec<String> {
    [
        ...
        "  local             cursor, viewport, selection, swatches, brush, paint color",
        "",
...
fn drawing_lines() -> Vec<String> {
    [
        ...
        "",
        "Paint color",
        "  Ctrl+U / Ctrl+Y    previous / next preset",
        "  Ctrl+K             color picker: R/G/B bars, hex, presets",
        "  Alt+K              take the color under the cursor",
        "  click a cell       in the Info box's palette rows picks that preset",
        "  Typed glyphs, swatch stamps, and fills all paint in this color; swatches store glyphs only.",
        "",
        "Selection",
...
fn brushes_lines() -> Vec<String> {
    [
        ...
        "",
        "Sample and glyphs",
        "  double-click cell  sample it into a one-glyph brush and take its color",
...
fn session_lines() -> Vec<String> {
    [
        ...
        "  Esc                back to the rail: board, gallery, hang a piece, archives",
        "  rail j/k, Enter    open a row; Esc out of a pane back to the rail",
        "  archives           the rail lists the keys; the board shows the one under the cursor",
